		...
		<div id="wrapperPannello" class="wrapperPannello no-gutter d-flex flex-column justify-content-center align-items-center ">
			<div id="pannelloForm" class="containerComp pannelloForm no-gutter">
				<div id="row_1" class="row">
					<div id="colonnaSx" class="colonna colonnaOTP codiceOTP">
						<div id="wrapperImmagine" class="logoPass">
							<!--img src="${url.resourcesPath}/img/logoPass.svg"-->
						</div>
						<div class="messaggioCodiceOtp">
							<p>
							Inserisici il codice OTP generato dalla tua app e premi Accedi per completare l'autenticazione
							</p>
						</div>
					</div>
