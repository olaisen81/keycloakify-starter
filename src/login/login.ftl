				...
				<div id="row_1" class="row">
					<div id="colonnaSx" class="colonna default">
						...
						<div class="wrapperMessaggio" id="wrapperSlogan">
							<h1>Accedi ai servizi Passepartout</h1>
							<div id="istruzioni-accesso" class="istruzioni">Inserisci le credenziali per effettuare il login</div>
						</div>
					</div>
										...
										<div id="kc-form-options">
											...
											<div class="${properties.kcFormOptionsWrapperClass!}">
												<#if realm.resetPasswordAllowed>
													<span><a class="linkRecupero" tabindex="5" href="${url.loginResetCredentialsUrl}">${msg("doForgotPassword")}</a></span>
												</#if>
											</div>
